 ...
 */
class RemoteDevice(id: Int, override val port: Int, override val address: InetAddress) : IncarnatedDevice(id), PhysicalDevice {
    ...
    fun goLightWeight() = LocalExecutionDevice(id, port, address)
}